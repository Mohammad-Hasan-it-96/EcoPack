...
class _AddOrderScreenState extends State<AddOrderScreen> {
  ...
  Future<void> _onOfferTap(Map<String, dynamic> offer) async {
    ...
    setState(() {
      ...
      _selectedOfferPrice = offer['price_after_discount']?.toString() ??
  ...
  double get _unitPrice {
    ...
    final priceStr =
        _selectedOfferPrice!.replaceAll(' ', '').replaceAll(',', '.');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _selectedOffer == null
          ? ListView.builder(
              padding: const EdgeInsets.all(16),
              itemCount: _offers.length,
              itemBuilder: (context, index) {
                final offer = _offers[index];
                final hasDiscount = (offer['discount'] ?? 0) > 0 &&
  ...
  Widget _buildOrderForm(BuildContext context, ThemeData theme) {
    ...
    return Center(
      child: Container(
        ...
        child: _locations.isNotEmpty && !_showAddLocationForm
