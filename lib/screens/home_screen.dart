                ...
                (address) => Padding(
                  ...
                  child: ListTile(
                    ...
                    title: Text(
                      ...
                      style: TextStyle(
                        fontWeight: address['isDefault'] == true
                            ? FontWeight.bold
                            : FontWeight.normal,
                      ),
                    ),
                          ...
                          onPressed: () {
                            ...
                            Navigator.of(context)
                              ...
                              MaterialPageRoute(
                                ...
                                .then((value) {
                              if (value == true && onAddressChanged != null) {
                                onAddressChanged!();
                              }
                            });
                          },
...
class _HomeScreenState extends State<HomeScreen>
  ...
  Future<void> _fetchHomeData() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // Promotions
        _promotionImages = (data['promotions'] as List)
            .map(
  ...
  void _showNotificationsDropdown(BuildContext context) async {
    ...
    final result = await showMenu(
      ...
      items: _lastNotifications.isEmpty
